...
Email _emailDeserialize(
  ...
  final object = Email(
    ...
    recipients: reader.readObjectList<Recipient>(
      offsets[1],
      RecipientSchema.deserialize,
      allOffsets,
      Recipient(),
    ),
    status: _EmailstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
        Status.pending,
...
extension EmailQueryWhere on QueryBuilder<Email, Email, QWhereClause> {
  QueryBuilder<Email, Email, QAfterWhereClause> isarIdEqualTo(Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Email, Email, QAfterWhereClause> isarIdNotEqualTo(Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Email, Email, QAfterWhereClause> isarIdGreaterThan(Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Email, Email, QAfterWhereClause> isarIdLessThan(Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension EmailQueryFilter on QueryBuilder<Email, Email, QFilterCondition> {
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> isarIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'isarId',
      ));
  ...
  QueryBuilder<Email, Email, QAfterFilterCondition> isarIdEqualTo(Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
        value: value,
